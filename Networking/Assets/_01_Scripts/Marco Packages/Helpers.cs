...
public static class Helpers
{
    ...
    public static T GetRandomEntry<T>(this ICollection<T> _array)
    {
        if (_array == null || _array.Count == 0) return default(T);
        return _array.ElementAt(Random.Range(0, _array.Count));
    }
